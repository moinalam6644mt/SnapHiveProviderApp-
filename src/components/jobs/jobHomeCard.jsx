...
import { User, MapPin, Calendar, Clock, Info, X } from 'lucide-react-native';
...
const JobHomeCard = ({ myBookingData = [], userId }) => {
        ...
        return (
          <View key={order_id} style={styles.card}>
            <View style={styles.topRow}>
              <Text style={styles.jobTitle}>{addressee_name || 'Service'}</Text>
