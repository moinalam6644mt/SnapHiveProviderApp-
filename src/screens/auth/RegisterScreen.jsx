...
export default function RegisterScreen() {
  ...
  if (dob.length !== 10) {
    Toast.show({ type: "error", text1: "Please enter a complete Date of Birth (DD-MM-YYYY)" });
    return;
  }
  ...
  if (year >= currentYear) {
    Toast.show({ type: "error", text1: `Year must be less than ${currentYear}` });
    return;
  }
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: scale(20), fontWeight: "700", color: "#474747" },
  inputBox: {
    flexDirection: "row",
    alignItems: "center",
  ...
  input: { flex: 1, fontSize: scale(14), color: "#000" },
  genderRow: {
    flexDirection: "row",
  ...
  genderText: { fontSize: scale(14), fontWeight: "600", color: "#2E2E74" },
  radio: {
    width: scale(22),
    height: scale(22),
  ...
  radioDot: { width: scale(10), height: scale(10), borderRadius: scale(5), backgroundColor: "#FFF" },
  checkboxRow: {
    flexDirection: "row",
    alignItems: "center",
    marginHorizontal: scale(20),
  ...
  checkboxText: { fontSize: scale(14), color: "#474747" },
  button: {
    height: scale(52),
  ...
  loginText: { fontSize: scale(12), color: "#474747" },
  loginLink: { fontSize: scale(12), color: "#ED6E0A", fontWeight: "600" },
